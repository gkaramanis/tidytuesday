...
legend <- ggplot() +
  ...
  annotate("polygon", x = c(0, 0.87, 0.87, 0, -0.87, -0.87) * 0.4 - 0.0, y = c(-1, -0.5, -0.5 + 0.7, 0.7, -0.5 + 0.7, -0.5)* 0.4 + 0.0, fill = "grey40", color = "grey40") +
  annotate("polygon", x = c(0, 0.87, 0.87, 0, -0.87, -0.87) * 0.4 + 0.35, y = c(-1, -0.5, -0.5 + 0.2, 0 + 0.2, -0.5 + 0.2, -0.5)* 0.4 - 0.2, fill = "grey75", color = "grey75") +
  # lines
