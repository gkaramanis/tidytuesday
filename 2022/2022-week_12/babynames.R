...
ggplot(names_ratio) +
  ...
  labs(
    ...
    subtitle = "Ratio of girls to boys for 168 000 names that were given to both genders from 1880 to 2017. Names that were given only to one gender are not shown.",
